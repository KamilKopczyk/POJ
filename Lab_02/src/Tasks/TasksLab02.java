...
public class TasksLab02 {
    ...
    protected String Task004(String zdanie01, String zdanie02){

        if(zdanie01.equals("1") && zdanie02.equals("1")){

            return "Weź parasol,Dostaniesz się na uczelnie";

        }else if(!zdanie01.equals("1")  && zdanie02.equals("1")){
            ...
            return "Możesz wprowadzić tylko 1 i 0";

        }

    }

    protected String Task005(String zdanie03, String zdanie04){

        if(zdanie03.equals("1") || zdanie04.equals("1")){


            return "Możesz kupić samochód !";


        } else if (!zdanie03.equals("1") || !zdanie04.equals("1")) {


            return ("Zakup samochód trzeba odłożyć na później... \n Zniżki na samochód nie ma");
